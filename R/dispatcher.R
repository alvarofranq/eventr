...
#' library(dplyr)
#'
#' birth_event <- event('first-id', type = 'BIRTH', time = '1936-11-09', birth_date = '1936-11-09')
#' death_event <- event('second-id', type = 'DEATH', time = '2019-05-22', death_date = '2019-05-22')
#'
...
#' dispatch <- the_dispatcher$dispatch
#'
...
#' the_obj %>% purrr::map(as.data.frame) %>% bind_rows
#'
#' @rdname dispatcher
#' @export
